...
1. 💪 Opened PR [#702](https://github.com/auth0/terraform-provider-auth0/pull/702) in [auth0/terraform-provider-auth0](https://github.com/auth0/terraform-provider-auth0)
2. ❌ Closed PR [#700](https://github.com/auth0/terraform-provider-auth0/pull/700) in [auth0/terraform-provider-auth0](https://github.com/auth0/terraform-provider-auth0)
3. 💪 Opened PR [#700](https://github.com/auth0/terraform-provider-auth0/pull/700) in [auth0/terraform-provider-auth0](https://github.com/auth0/terraform-provider-auth0)
4. 🎉 Merged PR [#699](https://github.com/auth0/terraform-provider-auth0/pull/699) in [auth0/terraform-provider-auth0](https://github.com/auth0/terraform-provider-auth0)
5. 🎉 Merged PR [#695](https://github.com/auth0/terraform-provider-auth0/pull/695) in [auth0/terraform-provider-auth0](https://github.com/auth0/terraform-provider-auth0)
