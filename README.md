...
1. 💪 Opened PR [#626](https://github.com/auth0/terraform-provider-auth0/pull/626) in [auth0/terraform-provider-auth0](https://github.com/auth0/terraform-provider-auth0)
2. 🎉 Merged PR [#622](https://github.com/auth0/terraform-provider-auth0/pull/622) in [auth0/terraform-provider-auth0](https://github.com/auth0/terraform-provider-auth0)
3. 🎉 Merged PR [#625](https://github.com/auth0/terraform-provider-auth0/pull/625) in [auth0/terraform-provider-auth0](https://github.com/auth0/terraform-provider-auth0)
4. 💪 Opened PR [#625](https://github.com/auth0/terraform-provider-auth0/pull/625) in [auth0/terraform-provider-auth0](https://github.com/auth0/terraform-provider-auth0)
5. ❌ Closed PR [#599](https://github.com/auth0/terraform-provider-auth0/pull/599) in [auth0/terraform-provider-auth0](https://github.com/auth0/terraform-provider-auth0)
